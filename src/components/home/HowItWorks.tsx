        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div key={step.id} className="bg-white rounded-lg shadow-md p-8 text-center relative">
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 bg-orange-100 rounded-full p-4 inline-flex items-center justify-center">
                {step.icon}
              </div>
              <div className="mt-8">
              ...
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-orange-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold">
                {step.id}
              </div>
            </div>
          ))}
        ...
        <div className="mt-20 bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-12 flex flex-col justify-center">
              ...
              <a href="/register?role=chef" className="inline-flex items-center text-orange-600 font-medium hover:text-orange-700">
